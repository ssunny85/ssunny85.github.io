---
title:  "Git"
excerpt: "업무 시 많이 사용하게 되는 git 명령어 정리"
tags:
  - git
last_modified_at: 
---
...
- **인덱스**
    ...
    : 변경된 작업 내역을 원격 저장소에 바로 기록하지 않고 

      로컬 저장소와 원격 저장소 사이 공간인 `인덱스`에 파일 상태를 기록(staging)
...
- branch
    ...
    로컬 저장소에서 작업 구분하여 로컬 브랜치를 생성 후 작업
...
![Git/image-merge.gif](img/git-merge.gif)
...
![Git/image-rebase.gif](img/git-rebase.gif)
